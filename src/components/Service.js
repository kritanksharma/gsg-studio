  ...
  return (
    <div>
      <div
        ...
        style={{ border: "none", borderRadius: "0px"  , backgroundImage: `url(${bg3})`, backgroundSize: "cover", opacity:1}}
      >
        <div className="card-body">
          <p className="text-light fs-2 fw-regular mt-2 ">Exploring the Mystique of Radiant Monument !!</p>
